...
void TimerCounterHandler_0_user_sp_cpu_dev0() {
    ...
    _v_l3__out = HIL_InAO(0x4);

    // Generated from the component: V_L1
    _v_l1__out = HIL_InAO(0x2);

    // Generated from the component: V_L2
    _v_l2__out = HIL_InAO(0x3);
    ...
    HIL_OutAO(0x2306, _pq_power_meter1__Qdc);
    // Generated from the component: Pac
    HIL_OutAO(0x2309, _pq_power_meter1__Pac);
    // Generated from the component: Qac
    HIL_OutAO(0x230a, _pq_power_meter1__Qac);
    // Generated from the component: S
    HIL_OutAO(0x2308, _pq_power_meter1__apparent);
    // Generated from the component: k
    HIL_OutAO(0x2307, _pq_power_meter1__k_factor);
    //@cmp.out.block.end
