...
void TimerCounterHandler_0_sys_sp_cpu_dev0() {
    ...
    _vrms3_vinst__out = HIL_InAO(0xa);

    // Generated from the component: Vrms2.Vinst
    _vrms2_vinst__out = HIL_InAO(0x9);
    ...
    _vrms1_vinst__out = HIL_InAO(0x8);
...
void TimerCounterHandler_1_sys_sp_cpu_dev0() {
    ...
    HIL_OutAO(0x2300, _irms1_rms_calc_slow__var_rms);
    ...
    HIL_OutAO(0x2301, _vrms1_rms_calc_slow__var_rms);
    ...
    HIL_OutAO(0x2302, _irms2_rms_calc_slow__var_rms);
    ...
    HIL_OutAO(0x2304, _irms3_rms_calc_slow__var_rms);
    ...
    HIL_OutAO(0x2303, _vrms2_rms_calc_slow__var_rms);
    ...
    HIL_OutAO(0x2305, _vrms3_rms_calc_slow__var_rms);
